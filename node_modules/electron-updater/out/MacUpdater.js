    ...
    return this.executeDownload({
      ...
      task: (destinationFile, downloadOptions) => {
        ...
        var _ref = (0, _bluebirdLst().coroutine)(function* (updateFile) {
          _this.updateInfoForPendingUpdateDownloadedEvent = downloadUpdateOptions.updateInfoAndProvider.info;
          ...
          return yield new Promise((resolve, reject) => {
            ...
            server.on("request", (request, response) => {
              ...
              _this._logger.info(`${fileUrl} requested by Squirrel.Mac, pipe ${updateFile}`);
